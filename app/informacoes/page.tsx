...
export default function InformacoesPage() {
  ...
  async function carregar() {
    ...
    setInformacoes(Array.isArray(data) ? data : []);
  }
  ...
  async function excluir(id: string) {
    ...
    await fetch(`/api/informacoes?id=${id}`, {
      method: "DELETE",
    });
  ...
  return (
    <div>
      ...
      <p style={{ color: "#64748b" }}>
        Cadastre respostas oficiais e palavras-chave para o bot encontrar a
        informação certa.
      </p>
      ...
      >
        ...
        >
          <h2 style={{ marginTop: 0 }}>
            {form.id ? "Editar informação" : "Nova informação"}
          </h2>
          ...
          <input
            placeholder="Categoria: filhotes, valores, entrega..."
          ...
          <textarea
            placeholder="Palavras-chave: entrega, entregam, frete, envio, cep..."
          ...
          <textarea
            placeholder="Conteúdo completo que o bot deve responder exatamente"
            value={form.conteudo}
            onChange={(e) =>
              setForm({
                ...form,
          ...
          <button disabled={salvando} style={button}>
            {salvando
              ? "Salvando..."
              : form.id
              ? "Salvar alterações"
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <button onClick={() => alternar(info)} style={smallButton}>
